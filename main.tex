...
\newglossaryentry{efcb}{
	name={EFCB},
	description={Estrada de Ferro Central do Brasil}
}
...
\newglossaryentry{efsj}{
	name={EFSJ},
	description={Estrada de Ferro Santos-Jundia\'{\i}}
}
...
\newglossaryentry{rffsa}{
	name={RFFSA},
	description={Rede Ferrovi\'{a}ria Federal Sociedade An\^{o}nima}
}
...
%	EDUARDO: ESFORÇOS DE INTEGRAÇÃO FEITOS PELA CPTM
